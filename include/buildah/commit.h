...
struct CommitOptions {
    ...
    std::shared_ptr<Compression> Compression=nullptr;  // 这里使用 std::string 表示压缩类型
    ...
    std::shared_ptr<SystemContext> SystemContext=nullptr;  // 根据实际定义进行类型替换
